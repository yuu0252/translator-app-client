...
export const languageCodeList: Array<obj> = [
  {
    ...
    speak: { code: 'en-US', speaker: 'en-US-Studio-Q' },
  },
  {
    code: 'en-gb',
    query: 'en',
    name: '英語（イギリス）',
    speak: { code: 'en-GB', speaker: 'en-GB-Studio-B' },
  },
  {
    code: 'en-sg',
    query: 'en',
    name: '英語（シンガポール）',
    speak: { code: 'en-US', speaker: 'en-US-Studio-O' },
  },
  {
    code: 'yue-hant-hk',
    query: 'zh-tw',
  ...
  },
  {
    ...
    speak: { code: 'fr-FR', speaker: 'fr-FR-Studio-D' },
  },
  {
    code: 'de-de',
    query: 'de',
  ...
  },
  {
    ...
    query: 'en',
    name: '英語（香港）',
    speak: { code: 'en-GB', speaker: 'en-GB-Studio-C' },
  },
  {
    code: 'en-ph',
    query: 'en',
